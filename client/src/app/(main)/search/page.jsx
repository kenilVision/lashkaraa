    ...
    useEffect(() => {
        const fetchData = async () => {
               console.log(query)
                    ...
                    const params = new URLSearchParams(); // ✅ Fix: declare params
        ...
        fetchData();
    }, [query ,activeFilters, sortOption, dispatch]);
            ...
            <div className="w-full max-w-[1500px] mx-auto md:px-12 px-2">
                <div className="flex flex-col justify-between md:flex-row lg:gap-14 gap-6 px-2">
                    ...
                    <div className="w-full ">
                        <div className='flex justify-center font-xxl text-center w-full my-8'>
                            <h2 className='text-3xl text-[#001D3D]'>Search results for "{query}"</h2>
                        </div>
