...
const PrivacyPolicy = () => {
    return (
        <div className='text-primary md:pb-6 pb-7 md:pt-8 pt-6 lg:px-0 md:px-[70px] px-4'>
            <h1 class="md:text-[40px] text-3xl font-seasons leading-[1.3] mb-8">Privacy Policy</h1>
            <Paragraph className={"mb-4 mt-2"}><span class="s1"><b>Lashkaraa Inc Privacy Policy |&nbsp;Our Commitment to Your Privacy</b></span></Paragraph>
            <Paragraph class="my-4"><span class="s1">At Lashkaraa, your privacy is very important to us.&nbsp; We strive to ensure that your experience with Lashkaraa is one that you will want to repeat and share with your friends. Part of our commitment to you is to respect and protect the privacy of the personal information you provide to us. The information below is designed to inform you of what information we collect when you visit or make a purchase from www.lashkaraa.com (the “Site”), how it is used, how it is safeguarded, and how you can contact us if you have any questions or concerns.</span></Paragraph>
            ...
            <Paragraph className="mt-4">
                <span>
                    ...
                    <br />
                    For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at info@lashkaraa.com.
                </span>
            </Paragraph>
        </div>
    )
